...
fn initialize_core_logic(app_handle: &AppHandle) {
    ...
    let phrase_manager = Arc::new(
        managers::phrases::PhraseManager::new(app_handle)
            .expect("Failed to initialize phrase manager"),
    );
...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::llm::get_task_model,
            commands::llm::set_task_model,
            ...
            commands::dictionary::get_custom_dictionary_words,
            commands::dictionary::add_custom_dictionary_word,
            commands::dictionary::remove_custom_dictionary_word,
