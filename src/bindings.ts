...
async changeTypedExpanderSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_typed_expander_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeTypedExpanderSoundSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_typed_expander_sound_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async ocrPdf(path: string) : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("ocr_pdf", { path }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async summarizeDocument(text: string, instruction: string) : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("summarize_document", { text, instruction }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getPhrases() : Promise<Result<PhraseRecord[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_phrases") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async addPhrase(key: string, aliases: string[], expansion: string) : Promise<Result<PhraseRecord, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("add_phrase", { key, aliases, expansion }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updatePhrase(id: number, key: string, aliases: string[], expansion: string) : Promise<Result<PhraseRecord, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_phrase", { id, key, aliases, expansion }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deletePhrase(id: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_phrase", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
experimental_field_streaming?: boolean; 
/**
 ...
 */
field_stream_throttle_ms?: number; 
/**
 ...
 */
field_stream_char_delay_ms?: number; 
/**
