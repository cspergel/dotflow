    ...
    <div className="max-w-3xl w-full mx-auto space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 text-sm bg-inset border border-hairline-strong rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/35 placeholder:text-faint"
        />
      </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg bg-inset text-muted hover:bg-text/8 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <RefreshCw
                ...
                <div className="relative" ref={languageDropdownRef}>
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                      languageFilter !== "all"
                        ...
                        : "bg-inset text-muted hover:bg-text/8"
                    }`}
                  >
                  ...
                  {languageDropdownOpen && (
                    <div className="absolute top-full right-0 mt-1 w-56 bg-panel border border-hairline-strong rounded-lg shadow-lg z-50 overflow-hidden">
                      <div className="p-2 border-b border-hairline">
                        <input
                          ...
                          className="w-full px-2 py-1 text-sm bg-inset border border-hairline-strong rounded-md focus:outline-none focus:ring-2 focus:ring-accent/35"
                        />
                      </div>
